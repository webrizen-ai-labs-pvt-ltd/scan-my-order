      ...
      <div className="bg-zinc-800 rounded-l-3xl border-y-2 border-l-2 border-zinc-700 flex justify-center items-center">
        <div className="max-w-xl mx-auto p-8 w-full">
          <div className="space-y-2 mb-6">
            ...
            <div className="pt-4">
              ...
              <p className="text-sm text-zinc-400 leading-relaxed">
                Enter your credentials or use biometric passkey to access the administrative dashboard.
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 text-xs text-zinc-400 max-w-xl">
            <b>Important Notice:</b> This is a restricted access system. Unauthorized access is prohibited and will be prosecuted by law.
          </div>
        </div>
      </div>
      <div className="bg-zinc-900 rounded-r-3xl border-y-2 border-r-2 border-zinc-700 overflow-hidden relative h-full">
        <img src="https://i.pinimg.com/1200x/20/16/57/201657f3c93339ccb3f6b69a3a5091c6.jpg" alt="Authentication" className="w-full h-full object-cover object-bottom" />
      </div>
    </div>
  )
}