...
export default function HomePage() {
  return (
    <div className="h-screen bg-zinc-950 text-zinc-100 flex flex-col justify-between relative">
      ...
      <img src="https://i.pinimg.com/736x/37/6d/61/376d61d595611ded0b7de3f0da4535b1.jpg" alt="Background" className="absolute inset-0 w-auto h-full object-cover top-0 left-0 grayscale border-y-6 border-r-6 rounded-r-3xl aspect-9/16" />
      ...
      <header className="px-6 py-4 flex items-center justify-between relative">
        <div className="p-3.5 flex flex-row items-center gap-3 ">
          ...
          <div className="flex flex-col overflow-hidden">
            ...
            <span className="truncate text-[10px] text-zinc-400">Operational OS</span>
          </div>
        </div>
      ...
      <main className="flex-1 flex flex-col p-6 md:p-12 max-w-3xl mx-auto gap-10 relative">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-xl">
            Manage your restaurant operations seamlessly across multiple platforms and locations, this single web app handles everything from POS integration to QR dining workflows.
          </p>
        </div>
              ...
              <div className="flex items-baseline gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed">
                    Enforce granular permissions across Owner, Manager, Waiter, and Kitchen roles.
                  </p>
                </div>
              </div>
            </div>
