  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      <div className="flex md:flex-row flex-col justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-zinc-900 dark:text-zinc-100 bg-gradient-to-r from-zinc-900 to-zinc-600 dark:from-zinc-100 dark:to-zinc-400 bg-clip-text text-transparent">
            Waiter Panel
          </h1>
          <p className="text-sm text-zinc-500 mt-1">Manage incoming requests and service queue efficiently.</p>
        </div>

        <div className="flex items-center gap-4 w-full md:justify-end justify-between md:mt-0 mt-4">
